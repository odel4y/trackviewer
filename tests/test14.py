#!/usr/bin/python
#coding:utf-8
# Comparing ordinary RandomForestRegressor and RandomForestSeparatedDirectionsAlgorithm
import sys
sys.path.append('../')
...
rfsd_algo = regressors.RandomForestSeparatedDirectionsAlgorithm(feature_list)
algos = [rf_algo, rfsd_algo]
