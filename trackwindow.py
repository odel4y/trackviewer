...
class TrackApp(object):
    ...
    def update_gpx_list(self):
        ...
        for gpx_file in self.gpx_manager.gpx_files:
            (_,file_name) = os.path.split(gpx_file.get_file_name())
            self.liststore_gpx.append([file_name, gpx_file.get_point_count()])
